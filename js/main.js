...
const projectData = [
  {
    ...
    techStack: ["Python"],
    srcURL: "https://github.com/krishna-negi05/Password-Generator",
  },
  {
    title: "CutLink",
    ...
    techStack: ["React", "MUI"],
    srcURL: "https://easy-cutlink.netlify.app/",
  },
  {
    title: "SysInfo",
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/krishna-negi05" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
function openModal() {
  ...
  // Make sure "Back to Portfolio" button closes the modal
